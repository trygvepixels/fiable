...
export const metadata = {
  title: "Waterproofing Services in Aliganj Lucknow | Fiable Building Solutions",
  description:
    "Looking for professional waterproofing in Aliganj, Lucknow? Fiable Building Solutions provides terrace, basement, bathroom, and wall dampness waterproofing in Aliganj area. Free site inspection. Call now.",
  alternates: {
    canonical: `${SITE_URL}/waterproofing-services-aliganj-lucknow`,
  },
  openGraph: {
    title: "Waterproofing Services in Aliganj Lucknow | Fiable",
    description:
      "Expert waterproofing contractor in Aliganj, Lucknow. Terrace, basement, bathroom & wall dampness treatment. Free inspection available.",
    url: `${SITE_URL}/waterproofing-services-aliganj-lucknow`,
    images: [{ url: heroImage, alt: "Waterproofing services in Aliganj Lucknow" }],
  },
};
...
const schema = [
  {
    ...
    "@type": "Service",
    "@id": `${SITE_URL}/waterproofing-services-aliganj-lucknow#service`,
    name: "Waterproofing Services in Aliganj, Lucknow",
    serviceType: "Waterproofing",
    description:
      "Professional waterproofing services in Aliganj, Lucknow — terrace waterproofing, basement waterproofing, bathroom sealing, and wall dampness treatment.",
    areaServed: {
      "@type": "Place",
      name: "Aliganj, Lucknow, Uttar Pradesh, India",
      geo: {
        "@type": "GeoCoordinates",
        latitude: "26.8862",
        longitude: "80.9388",
  ...
  },
  {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: "Aliganj Lucknow", item: `${SITE_URL}/waterproofing-services-aliganj-lucknow` },
    ],
  },
];
...
const services = [
  {
    ...
    desc: "PU membrane systems, crack bridging, and flood-tested protection for Aliganj terraces exposed to UP monsoon heat cycles.",
  },
  {
    title: "Basement Waterproofing",
    desc: "Crystalline slurry, APP sheets, and pressure-injection grouting for basements and underground areas in Aliganj buildings.",
  },
  {
    title: "Bathroom & Wet Area Sealing",
    desc: "Detail-focused bathroom waterproofing around sunken slabs, drain joints, and pipe penetrations for Aliganj homes.",
  },
  {
...
const faqs = [
  {
    q: "Why is waterproofing essential for properties in Aliganj?",
  ...
  },
  {
    ...
    a: "Our diagnostic site inspection in Aliganj takes about 30 to 45 minutes. We use moisture meters to locate dampness source and suggest exact restoration steps.",
  },
];
    ...
    <>
      ...
      <main className="min-h-screen bg-[#F4F1EC] pt-20">
        ...
        <section className="relative h-[65vh] w-full flex items-center justify-center overflow-hidden">
          <img
            src={heroImage}
            alt="Professional Waterproofing Services in Aliganj Lucknow"
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mt-4 leading-tight special-font">
              ...
              <span className="text-blue-400 font-extrabold">Aliganj, Lucknow</span>
            </h1>
        ...
        <section className="max-w-7xl mx-auto px-6 py-16 md:py-24 grid md:grid-cols-12 gap-12 items-center">
          <div className="md:col-span-7">
            <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 leading-tight special-font">
              Why Homeowners & Commercial Managers in <span className="text-blue-700 font-bold">Aliganj</span> Choose Fiable
            </h2>
            <p className="text-gray-700 mt-6 text-base leading-relaxed md:text-lg">
              Aliganj houses some of Lucknow's finest residential colonies and commercial setups. However, water leakage from open terraces, expansion joints, or poor foundation construction can destroy interior paint, weaken reinforcement steel, and lead to structural damage.
            </p>
          ...
          <div className="md:col-span-5 bg-white p-8 rounded-2xl border border-gray-200/60 shadow-sm relative overflow-hidden">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-medium text-gray-900">Coverage in Aliganj</h4>
                  <p className="text-sm text-gray-600 mt-1">Full service availability across all sectors and main roads in the Aliganj area.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl md:text-4xl font-semibold text-gray-900 special-font">
                Waterproofing Services We Offer in <span className="text-blue-700">Aliganj</span>
              </h2>
